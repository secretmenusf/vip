...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Subscribe to access Chef Antje\'s weekly menus. Access ($29/mo) unlocks the menu + ordering + Chef AI. Plus ($79/mo) includes a meal credit. Solo Dev ($399/mo) is for power users with $350 credits. Hacker House ($999/mo) is for teams with $900 credits. SF Bay Area delivery only. Cancel or pause anytime.',
    },
    {
